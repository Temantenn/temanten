...
class SecurityHeaders
{
    ...
    protected function buildContentSecurityPolicy(Request $request): string
    {
        ...
        $directives = [
            "default-src 'self'",
            "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://unpkg.com https://www.youtube.com https://s.ytimg.com https://*.googletagmanager.com" . ($isDev ? " ws://localhost:* http://localhost:* http://127.0.0.1:*" : ""),
            "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://fonts.bunny.net https://fonts.gstatic.com",
            "img-src 'self' data: blob: https: http:",  // https: + http: untuk cover Unsplash + tema gallery
            "font-src 'self' data: https://fonts.gstatic.com https://fonts.bunny.net https://unpkg.com",
