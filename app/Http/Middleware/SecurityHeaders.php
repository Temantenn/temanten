...
class SecurityHeaders
{
    ...
    protected function buildContentSecurityPolicy(Request $request): string
    {
        ...
        $directives = [
            "default-src 'self'",
            "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.youtube.com https://s.ytimg.com https://*.googletagmanager.com" . ($isDev ? " ws://localhost:* http://localhost:* http://127.0.0.1:*" : ""),
